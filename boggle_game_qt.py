...
class BoggleAppQt(QMainWindow):
    ...
    def setup_ui(self):
        ...
        self.stats_view = boggle_visualizer_qt.StatsWindowQt(game_id=None, debug=self.debug_mode)
    ...
    def process_stats(self, interrupted=False, silent=False):
        ...
        self.stats_view = boggle_visualizer_qt.StatsWindowQt(game_id=game_id, debug=self.debug_mode)
        self.stats_layout.addWidget(self.stats_view)
